    ...
    if (sallitutTyypit.includes(tyyppi)){
        ...
        req.on('end', () => {
            ...
            if (tyyppi === 'application/json'){
                // jos takaisinkutsufunktio on lahetaVastaus,
                // tämä muuttuu muotoon lahetaVastaus(res, JSON.parse(data);
...
const palvelin = http.createServer( (req, res) => {
    // Käsitellään funktiossa pyynnön POST-tyyppinen data.
    // Takaisinkutsufunktio huolehtii vastauksen lähettämisestä.
